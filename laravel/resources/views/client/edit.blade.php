  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <form role="form" class="validate" method="post" action="{{ route('client.update', ['client_id' => $client->id]) }}">
            @csrf
            <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Informe o CPF" type="text" id="input-CPF" name="CPF" value="{{ $client->CPF }}" readonly required>
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-name">Nome</label>
                        <input class="form-control" placeholder="Informe o nome" type="text" id="input-name" name="name" value="{{ $client->name }}" required>
                      </div>
                    </div>
                  </div>
                </div>
